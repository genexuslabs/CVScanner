...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fabScan.setOnClickListener(view ->
                CVScanner.startScanner(this, false, true, true, FilterType.Color, true, 0, false, 3, REQ_SCAN));
    ...
    void startScannerIntent(boolean isPassport, boolean showFlash, boolean disableAutomaticCapture, FilterType filterType, boolean allowTypeSelection, double aspectRatio, boolean singleDocument, int maximumScans) {
        CVScanner.startScanner(this, isPassport, showFlash, disableAutomaticCapture, filterType, allowTypeSelection, aspectRatio, singleDocument, maximumScans, REQ_SCAN);
    }
